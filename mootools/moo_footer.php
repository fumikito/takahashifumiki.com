...
<?php endif; ?>
<!-- Scripts -->
<script src="<?php echo bloginfo('template_directory'); ?>/mootools/mootools.js" type="text/javascript"></script>
<script src="<?php bloginfo('template_directory'); ?>/mootools/moo_searchbox.js" type="text/javascript"></script>
</body>
</html>