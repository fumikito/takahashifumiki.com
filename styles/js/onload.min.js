...
)this.colYs[f]=Math.max(a,this.colYs[f])};r.prototype._getContainerSize=function(){this.maxY=Math.max.apply(Math,this.colYs);var e={height:this.maxY};this.options.isFitWidth&&(e.width=this._getContainerFitWidth());return e};r.prototype._getContainerFitWidth=function(){var e=0,t=this.cols;while(--t){if(this.colYs[t]!==0)break;e++}return(this.cols-e)*this.columnWidth-this.gutter};r.prototype.resize=function(){var e=this.containerWidth;this.getContainerWidth();if(e===this.containerWidth)return;this.layout()};return r}var t=Array.prototype.indexOf?function(e,t){return e.indexOf(t)}:function(e,t){for(var n=0,r=e.length;n<r;n++){var i=e[n];if(i===t)return n}return-1};typeof define=="function"&&define.amd?define(["outlayer/outlayer","get-size/get-size"],n):e.Masonry=n(e.Outlayer,e.getSize)})(window);jQuery(document).ready(function(e){function t(){var t;e(".margin").width()<760?t=window.innerHeight-50:t=e(window).height()-100;e("#to-top").css("top",t)}function u(t){if(!e(this).hasClass("tip-toggle")){if(e(this).parents(".quotescollection_randomquote").length>0)return;var n="";e(this).attr("cite")?n=e(this).attr("cite").toString():e(this).attr("title")?n=e(this).attr("title").toString():e(this).attr("alt")?n=e(this).attr("alt").toString():e(this).hasClass("tip")&&(n=e(this).text().toString());if(n.length<1)return!1;switch(this.nodeName.toLowerCase()){case"q":n="<strong>引用元</strong><br />"+n;break;case"abbr":n="<strong>略語</strong><br />"+n;break;case"acronym":n="<strong>頭字語</strong><br />"+n}e("#tip-container td.content").html(n);if(document.ontouchstart!==undefined){var r=e(this).width()/2,i=e(this).offset(),s=e(window).height()/2+e(window).scrollTop(),u=e(window).width()/2,a=i.left+(i.left>u?-1*(e("#tip-container").width()+r):r),f=i.top+(i.top>s?-1*(e("#tip-container").height()+r):r);e("#tip-container").css({top:f,left:a})}o.fadeIn("fast");e(this).addClass("tip-toggle");return!0}e(this).removeClass("tip-toggle");o.fadeOut("fast")}(/Firefox/.test(navigator.userAgent)||/MSIE/.test(navigator.userAgent)&&!/MSIE (5|6|7|8|9)\.0/.test(navigator.userAgent))&&e("body").addClass("non-filter-blur");e("p.message").each(function(t,n){var r=!1;e(n).hasClass("warning")?r="fa-warning":e(n).hasClass("success")?r="fa-check-circle":e(n).hasClass("notice")&&(r="fa-lightbulb-o");r&&e(n).prepend('<i class="'+r+'"></i>')});e(".netabare").each(function(t,n){var r=e('<a class="netabare-opener button" href="#" data-index="'+(t+1)+'"><i class="fa-folder-open"></i>ネタバレ表示</a>'),i=e(n).height()/2*-1;e(n).after(r);r.click(function(t){t.preventDefault();if(confirm("この部分はネタバレを含みます。表示してよろしいですか？")){e(this).prev(".netabare").removeClass("netabare");try{ga("send",{hitType:"event",eventCategory:"netabare",eventAction:window.location.pathname,eventLabel:e(this).attr("data-index"),eventValue:1})}catch(t){}e(this).remove()}}).css({top:i+"px"})});if(e.fancybox&&!e("body").hasClass("smartphone")){e(".entry a").each(function(t,n){if(n.href.match(/(jpe?g|gif|png)$/i)){n.rel="fancyboxGroup";e(n).next("wp-caption-text").length>0?n.title=e(n).next("wp-caption-text").text():e(n).find("img").length>0&&(n.title=e(n).find("img").attr("alt"))}});e(".entry a[rel=fancyboxGroup]").fancybox({prevEffect:"none",nextEffect:"none",closeBtn:!1,helpers:{thumbs:{width:50,height:50},buttons:{}}});w=700;h=e(window).height()-100;title=!0;e(".ebook-read-more a").fancybox({autoDimensions:!1,centerOnScroll:!0,height:h,width:w,titleShow:title,titlePosition:"inside"})}t();e(window).resize(t);e("#to-top a").click(function(t){t.preventDefault();if(e("html").scrollTop()>0)var n=e("html");else if(e("body").scrollTop()>0)var n=e("body");n.animate({scrollTop:0},"fast")});e(window).scroll(function(){e(this).scrollTop()<=28+e("#navi").height()?e("#to-top").css("display")!=="none"&&e("#to-top").fadeOut():e("#to-top").css("display")==="none"&&e("#to-top").fadeIn()});if(e("body").hasClass("smartphone")){setTimeout(function(){window.scrollTo(0,1)},100);var n=null;e(".ebook-read-more a").click(function(t){t.preventDefault();var r,i,s,o,u;s=e(window).width();o=window.innerHeight?window.innerHeight:e(window).height();r=e(window).scrollTop();u=40;if(n===null){n=e(document.createElement("div")).addClass("ebook-more-modal").css({top:i+r,left:0,width:s,height:o-u,paddingTop:u,display:"none"});var a=e(document.createElement("div")).addClass("ebook-more-title sans").text(e(this).attr("title")),f=e(document.createElement("a")).addClass("button").addClass("ebook-more-close").text("×").attr("href","#");n.append(a).append(f).appendTo(e("body"));f.click(function(t){t.preventDefault();n.css("display","none");e("#ebook-more-content").css({height:"auto"}).prependTo(e(".ebook-more"))})}n.css("top",r).fadeIn();e("#ebook-more-content").css({height:o-u-20}).prependTo(n)});var r=e("#book-shelf .lwp-table");if(r.length>0){var s=e('<div class="entry"></div>');s.dialog({autoOpen:!1,title:"決済情報詳細",modal:!0,position:["center","center"],width:300,maxHeight:window.innerHeight-56,resizable:!1});r.find("tbody tr").click(function(t){var n="<table><tbody>";for(i=0,l=e(this).find("td").length;i<l;i++)n+="<tr><th>"+e(this).parents("table").find("thead th:eq("+i+")").text()+"</th><td>"+e(this).find("td:eq("+i+")").html()+"</td></tr>";n+="</tbody></table>";s.html(n);s.dialog("open")})}}var o=e("#tip-container");if(document.ontouchstart!==undefined){e(".tip, abbr, acronym, q").click(u);o.find("button").click(function(){o.fadeOut("fast");e(this).removeClass("tip-toggle")});o.addClass("touch")}else e(".tip, abbr, acronym, q").hover(u).mousemove(function(e){var t=offsetX=10,n=posX=0;window.innerHeight-e.screenY<200?n=e.pageY-t*8-o.height():n=e.pageY-t;window.innerWidth-e.screenX<300?posX=e.pageX-offsetX*3-o.width():posX=e.pageX+offsetX;o.css({top:n,left:posX})});var a=function(){e.post(FumikiAjax.endpoint,{action:"ustream_status",nonce:FumikiAjax.nonce},function(t){if(t.status==1){if(e("#ustream-badge").length<1){e("body").append('<a id="ustream-badge" href="http://ustre.am/oqqL">Ustream 一人バーベキュー配信中</a>');var n=function(){return e(window).scrollTop()+(e(window).height()-225)/2};e("#ustream-badge").css({top:n()+"px"}).fadeIn("slow");setInterval(function(){e("#ustream-badge").fadeTo(1e3,.4,function(){e("#ustream-badge").fadeTo(1e3,1)})},3e3);var r=null,i=function(t){clearTimeout(r);r=setTimeout(function(){e("#ustream-badge").animate({top:n()+"px"},{duration:"slow"});clearTimeout(r)},1e3)};e(window).scroll(i);e(window).resize(i);e("#ustream-badge").hover(function(t){e("#ustream-badge").animate({width:"320px"},{duration:"fast"})},function(t){e("#ustream-badge").animate({width:"40px"},{duration:"fast"})})}}else e("#ustream-badge").length>0&&e("#ustream-badge").remove()})};a();setInterval(a,12e4)});(function(e){e.event.add(window,"load",function(){e(".twitter-tweet-rendered").each(function(t,n){e(n).attr("style","").removeClass("twitter-tweet-rendered").addClass("fumiki-twitter-rendered")})})})(jQuery);