...
<footer class="dark_bg footer">
		...
		<div class="grid_4 last">
			...
			<?php if ( ! wp_is_mobile() ) :  ?>
				...
				<ol class="inner sites no-if-touch">
					<li><a class="hametuha one-line" target="_blank"
					       href="http://hametuha.com/author/takahashi_fumiki/">破滅派 | 文芸誌</a></li>
					<li><a class="hametuha-inc one-line" target="_blank" href="http://hametuha.co.jp">株式会社破滅派</a></li>
					<li><a class="minicome one-line" target="_blank" href="http://minico.me">ミニコme! | ミニコミ誌販売ポータル</a>
					</li>
				</ol>
			<?php endif; ?>
			...
			<ol class="inner no-text clearfix">
				...
				<li>
					<a target="_blank" class="instagram"
					   href="http://www.linkedin.com/pub/<?= rawurlencode( '文樹-高橋' ) ?>/41/5b4/a54">
			...
			<ol class="inner">
				...
				<?php if ( ! wp_is_mobile() ) :  ?>
					<li><a class="mail" href="<?php echo home_url( '/inquiry/', 'https' ); ?>"><i
								class="fa-envelope-o"></i>お問い合わせ</a></li>
					<li><a class="feed" href="<?php bloginfo( 'rss_url' ); ?>"><i class="fa-rss-square"></i>RSSフィード</a>
					</li>
				<?php endif; ?>
			</ol>
		</div><!-- //.grid_4 -->
	...
	<p class="divider center">
		<img src="<?= get_template_directory_uri() ?>/styles/img/divider.png" alt="takahashifumiki.com" width="100"
		     height="100"/>
	</p>
